local koma_rafte = " in the name of Koma "
...
local is_koma_rafte = function(user_id) --such a useless function
  local var = false
  if user_id == tonumber(koma_rafte) then
    var = true
  end
  return var
end
